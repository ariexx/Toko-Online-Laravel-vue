              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  <carousel class="product-thumbs-track ps-slider" :nav="false" :autoplay="true">
                    <div v-for="photo in photos" :key="photo" class="pt" :class="photo == defaultImage ? 'active' : ''" @click="changeImage(photo)">
                      <img :src="photo" alt="" />
                    </div>
                  </carousel>
                </div>
...
<script>
import HeaderShayna from "@/components/template/HeaderShayna.vue";

import FooterShayna from "@/components/template/FooterShayna.vue";
...
export default {
  ...
  data() {
    return {
      defaultImage: "img/mickey1.jpg",
      photos: ["img/mickey1.jpg", "img/mickey2.jpg", "img/mickey3.jpg", "img/mickey4.jpg"],
      isActive: false,
    };
  },
